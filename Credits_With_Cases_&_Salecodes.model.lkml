...
join: aged_debt_view {
  ...
  join: vw_credits_w_salecodes_only {
    ...
    relationship: one_to_one
    sql_on: ${vw_credits_w_salecodes_only.customer_account_key} = ${vw_credits_cases_w_salecodes.customer_account_key} and ${vw_credits_cases_w_salecodes.cnote_key} = ${vw_credits_w_salecodes_only.cnote_key} ;;
  }
